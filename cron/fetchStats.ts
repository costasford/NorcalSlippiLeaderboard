...
const getPlayerConnectCodes = async (): Promise<string[]> => { 
	return ['C4D#69','DUFF#838','YBAI#170','NATE#925','BLRG#257','BO#80','UMAR#289','AS#656','IRON#446','VIAL#2','JACK#925','SF#0','MSZ#006','CAT#614','SNAP#1','ARCA#521','TM#42','PENG#444','IBS#20','DUSKY#96','BRO#0','GRIF#526','PHRX#0','AWAE#209','DENZ#432','HIRO#702','XDXD#579','SFAT#9','DASH#909','GGG#366','DAHONG#8','CALP#463','DCCD#590','MAYBE#0','VYGR#415','LARS#342','OWEN#256','ITLY#654','CHAD#543','GOTH#666','RUSS#204','KB#795','JNOD#789','RP#263','POOP#733','B#0','BOT#0','BEZE#579','FRAC#575','MRG#172','WRXJ#644','ETRO#892','ZMLZ#826','WALL#142','ARCA#349','JAX#124','TRUE#768','JOEY#312','MM#391','BOND#007','LEJF#640','BAGE#751','BIO#324','QUIK#330','SWAN#349','KIM#4','TURT#785','ELFL#359','KWAN#900','ROWF#148','FUZZ#987','ELKG#852','CKIE#711','BDSH#255','SMUS#707','INDI#794','TUAR#403','YAMS#920','LIU#322','FREE#195','MOJ#383','PREY#969','DONG#323','LUNK#783','BISCUI#0','XXBO#793'] };
